...
def ResNet18(num_class=1000, enable_bias=False):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_class)


def ResNet34(num_class=1000, enable_bias=False):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_class)


def ResNet50(num_class=1000, enable_bias=False):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_class)


def ResNet101(num_class=1000, enable_bias=False):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_class)


def ResNet152(num_class=1000, enable_bias=False):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_class)


def make_resnet(arch, num_class=1000, enable_bias=False):
    arch = arch.lower()
    ...
    model = ResNet(building_block, layer_block_num, num_class, enable_bias)
    return model

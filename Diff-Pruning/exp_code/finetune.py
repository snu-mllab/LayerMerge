...
def parse_args_and_config(accelerator):
    ...
    if args.sample or args.measure:
...
def main():
    ...
    try:
        ...
        if args.sample:
            ...
            mean_syn, std_syn, mean_thpt, std_thpt = runner.sample_time()
            print(f"mean_syn: {mean_syn}, std_syn: {std_syn}, mean_thpt: {mean_thpt}, std_thpt: {std_thpt}")
        else:

...
def make_depth_layer_resnet(arch, class_num, enable_bias, act_ind, conv_ind):
    if arch == "resnet34":
        model: DepthLayerResNet = ResNet34(class_num, enable_bias)
    elif arch == "resnet50":
        model: DepthLayerResNet = ResNet50(class_num, enable_bias)
    else:
        raise NotImplementedError()
